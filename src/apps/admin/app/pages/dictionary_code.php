...
SQL;
			$stmt = $cs->query($sql, [':di_name' => $di_name, ':di_fr_short' => $di_fr_short, ':di_fr_long' => $di_fr_long, ':di_en_short' => $di_en_short, ':di_en_long' => $di_en_long, ':di_ru_short' => $di_ru_short, ':di_ru_long' => $di_ru_long]);
		break;
		case "Modifier":
			$di_name = filterPOST("di_name");
			$di_fr_short = filterPOST("di_fr_short");
...
SQL;
		...
		echo "<script language='JavaScript'>window.location.href='page.html?id=61&lg=fr'</script>";
	}
