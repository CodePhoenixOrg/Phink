...
SQL;
			$stmt = $cs->prepare($sql);
			$stmt->execute([':me_level' => $me_level, ':me_target' => $me_target, ':pa_id' => $pa_id, ':bl_id' => $bl_id, ':me_charset' => $me_charset]);
		break;
		case "Modifier":
			$me_level = filterPOST("me_level");
			$me_target = filterPOST("me_target");
...
SQL;
			$stmt = $cs->prepare($sql);
			$stmt->execute([':me_level' => $me_level, ':me_target' => $me_target, ':pa_id' => $pa_id, ':bl_id' => $bl_id, ':me_charset' => $me_charset, ':me_level' => $me_level, ':me_target' => $me_target, ':pa_id' => $pa_id, ':bl_id' => $bl_id, ':me_charset' => $me_charset]);
		break;
		case "Supprimer":
