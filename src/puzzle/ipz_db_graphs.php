...
{
    public function colorRange($number)
    {
        $r_angle = 0;
        $g_angle = 120;
        $b_angle = 240;
    ...
    public function darkColorRange($number)
    {
        $r_angle = 0;
        $g_angle = 120;
        $b_angle = 240;
    ...
    public function legend($name, $data, $data_type, $caption_name, $caption_size, $margin_size, $border)
    {
        $legend_data = "";
    ...
    public function legendTable($name, $recordset, $caption_size, $refs)
    {
        $legend_data = "";
        if ($data_type == PERCENT) {
            $legend_data = " %";
    ...
    public function camembert($name, $series, $highlight, $data_type, $sql, $width, $height, $caption_size, $caption_name, $cs)
    {
        $gh = $height;
        $gw = $width;
        $iw = $gw;
    ...
    public function histogram($name, $series, $highlight, $data_type, $unit, $sql, $width, $height, $percent_width, $caption_size, $caption_name, $color, $highlight_color, $cs)
    {
        $gh = $height * 0.80;
        //$gw=$width*0.80;
