...
--
-- Create schema alphas
--

CREATE DATABASE IF NOT EXISTS alphas;
USE alphas;

DROP TABLE IF EXISTS `alphas`.`__app_document`;
CREATE TABLE  `alphas`.`__app_document` (
...
DROP TABLE IF EXISTS `alphas`.`__dbconn_app`;
CREATE TABLE  `alphas`.`__dbconn_app` (
...
DROP TABLE IF EXISTS `alphas`.`__document_form`;
CREATE TABLE  `alphas`.`__document_form` (
  `doc_id` int(10) NOT NULL,
...
DROP TABLE IF EXISTS `alphas`.`__form_block`;
CREATE TABLE  `alphas`.`__form_block` (
  `frm_id` int(10) NOT NULL,
...
DROP TABLE IF EXISTS `alphas`.`__member_newletter`;
CREATE TABLE  `alphas`.`__member_newletter` (
...
DROP TABLE IF EXISTS `alphas`.`__user_app`;
CREATE TABLE  `alphas`.`__user_app` (
...
DROP TABLE IF EXISTS `alphas`.`_block_type`;
CREATE TABLE  `alphas`.`_block_type` (
  `bt_id` int(10) NOT NULL,
  `bt_type` varchar(10) NOT NULL,
  PRIMARY KEY (`bt_id`),
  UNIQUE KEY `PK_block_type` (`bt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO `alphas`.`_block_type` VALUES  (1,'form      '),
 (2,'menu      ');

DROP TABLE IF EXISTS `alphas`.`_bug_status`;
CREATE TABLE  `alphas`.`_bug_status` (
  `bs_id` int(10) NOT NULL,
  `bs_status` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`bs_id`),
  UNIQUE KEY `PK_bug_status` (`bs_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO `alphas`.`_bug_status` VALUES  (1,'à fixer'),
 (2,'en cours'),
 (3,'fixé'),
 (4,'suspendu'),
 (5,'abandonné');

DROP TABLE IF EXISTS `alphas`.`_dbserver_type`;
CREATE TABLE  `alphas`.`_dbserver_type` (
  `dbs_id` int(10) NOT NULL,
  `dbs_type` varchar(10) NOT NULL,
  PRIMARY KEY (`dbs_id`),
  UNIQUE KEY `PK_dbserver_type` (`dbs_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO `alphas`.`_dbserver_type` VALUES  (1,'MySQL'),
 (2,'SQL Server'),
 (3,'SQLite');

DROP TABLE IF EXISTS `alphas`.`_document_type`;
CREATE TABLE  `alphas`.`_document_type` (
...
DROP TABLE IF EXISTS `alphas`.`_form_type`;
CREATE TABLE  `alphas`.`_form_type` (
  `ft_id` int(10) NOT NULL,
  `ft_type` varchar(10) NOT NULL,
  PRIMARY KEY (`ft_id`),
  UNIQUE KEY `PK_form_type` (`ft_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO `alphas`.`_form_type` VALUES  (1,'html'),
 (2,'php'),
 (3,'aspx');

DROP TABLE IF EXISTS `alphas`.`_protocol_type`;
CREATE TABLE  `alphas`.`_protocol_type` (
...
DROP TABLE IF EXISTS `alphas`.`applications`;
CREATE TABLE  `alphas`.`applications` (
  `app_id` int(10) NOT NULL,
...
INSERT INTO `alphas`.`applications` VALUES  (1,NULL,19,NULL);

DROP TABLE IF EXISTS `alphas`.`blocks`;
CREATE TABLE  `alphas`.`blocks` (
  `bl_id` int(10) NOT NULL,
...
INSERT INTO `alphas`.`blocks` VALUES  (1,'1',2,0);

DROP TABLE IF EXISTS `alphas`.`bugreport`;
CREATE TABLE  `alphas`.`bugreport` (
...
DROP TABLE IF EXISTS `alphas`.`changelog`;
CREATE TABLE  `alphas`.`changelog` (
...
DROP TABLE IF EXISTS `alphas`.`dbconn`;
CREATE TABLE  `alphas`.`dbconn` (
  `dbc_id` int(10) NOT NULL,
...
INSERT INTO `alphas`.`dbconn` VALUES  (1,'localhost','alphas','root','',1);

DROP TABLE IF EXISTS `alphas`.`dictionary`;
CREATE TABLE  `alphas`.`dictionary` (
  `di_id` int(10) NOT NULL,
...
INSERT INTO `alphas`.`dictionary` VALUES  (0,'na','N/A','N/A','N/A','N/A','',''),
...
DROP TABLE IF EXISTS `alphas`.`documents`;
CREATE TABLE  `alphas`.`documents` (
  `doc_id` int(10) NOT NULL,
...
DROP TABLE IF EXISTS `alphas`.`forms`;
CREATE TABLE  `alphas`.`forms` (
  `frm_id` int(10) NOT NULL,
...
INSERT INTO `alphas`.`forms` VALUES  (17,'mkmain.php','.','',9,2,1),
 (18,'menus.php','.','',11,2,1),
 (19,'pages.php','.','',17,2,1),
 (20,'blocks.php','.','',2,2,1),
...
DROP TABLE IF EXISTS `alphas`.`groups`;
CREATE TABLE  `alphas`.`groups` (
...
INSERT INTO `alphas`.`groups` VALUES  (1,'root           ','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y','Y');

DROP TABLE IF EXISTS `alphas`.`members`;
CREATE TABLE  `alphas`.`members` (
  `mbr_id` int(10) NOT NULL,
...
INSERT INTO `alphas`.`members` VALUES  (1,'David BLANCHARD','Pas d\'adresse','','76000','davidbl@wanadoo.fr','dpjb',''),
 (2,'Pierre-Yves Le Bihan','Pas d\'adresse','','92800','pylb@wanadoo.fr','pylb','');

DROP TABLE IF EXISTS `alphas`.`menus`;
CREATE TABLE  `alphas`.`menus` (
...
INSERT INTO `alphas`.`menus` VALUES  (17,'1','page',17,1),
 (18,'1','page',18,1),
 (19,'1','page',19,1),
 (20,'1','page',20,1),
 (21,'1','page',21,1),
...
DROP TABLE IF EXISTS `alphas`.`newsletter`;
CREATE TABLE  `alphas`.`newsletter` (
  `nl_id` int(10) NOT NULL,
...
DROP TABLE IF EXISTS `alphas`.`queries`;
CREATE TABLE  `alphas`.`queries` (
...
DROP TABLE IF EXISTS `alphas`.`storage`;
CREATE TABLE  `alphas`.`storage` (
...
INSERT INTO `alphas`.`storage` VALUES  (1,'admin','http://localhost',NULL,NULL,NULL);

DROP TABLE IF EXISTS `alphas`.`todo`;
CREATE TABLE  `alphas`.`todo` (
...
DROP TABLE IF EXISTS `alphas`.`users`;
CREATE TABLE  `alphas`.`users` (
  `usr_id` int(10) NOT NULL,
  `mbr_id` int(10) NOT NULL,
  `grp_id` int(10) NOT NULL,
  PRIMARY KEY (`usr_id`),
...
INSERT INTO `alphas`.`users` VALUES  (1,1,1),
 (2,2,1);
