...
<?php   
	...
	if($query === "SELECT") {
		...
		$dbgrid = $datacontrols->createPagerDbGrid("bugs", $sql, $id, "", "&query=ACTION$curl_pager", "", true, true, $dialog, array(0, 400), 15, $grid_colors, $cs);
...
?>
<form method="POST" name="bugreportForm" action="?id=64&lg=fr">
