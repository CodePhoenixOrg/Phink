...
//        $this->redis->mset($this->preHtmlName, $this->declarations . $this->viewHtml);
        ...
        // On a g�n�r� le code mais on ne l'a pas pars� au sens "ex�cut�" du terme 
        // donc on sort avec le flag FAUX pour indiquer qu'il doit encore �tre ex�cut�
        return false;
